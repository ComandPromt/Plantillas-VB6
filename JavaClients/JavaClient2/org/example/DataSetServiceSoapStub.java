...
public class DataSetServiceSoapStub extends org.apache.axis.client.Stub implements org.example.DataSetServiceSoap {
    ...
    public DataSetServiceSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        try {
            ...
            qName = new javax.xml.namespace.QName("http://example.org/dataset", "AuthorSetType");
            cachedSerQNames.add(qName);
            cls = org.example.AuthorSetType.class;
            ...
            qName = new javax.xml.namespace.QName("http://example.org/dataset", "AuthorType");
            cachedSerQNames.add(qName);
            cls = org.example.AuthorType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
