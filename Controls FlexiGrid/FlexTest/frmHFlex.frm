...
Begin VB.Form frmHFlex 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select CustomerID,ShipName,OrderID,OrderDate,RequiredDate from Orders Order by CustomerID"
      Caption         =   " "
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
      Bindings        =   "frmHFlex.frx":0000
      DragIcon        =   "frmHFlex.frx":001B
      Height          =   3840
      Left            =   60
      TabIndex        =   1
      Top             =   60
      ...
      MergeCells      =   4
      AllowUserResizing=   1
      FormatString    =   "CustomerID|ShipName|OrderID|OrderDate|RequiredDate"
      _NumberOfBands  =   1
      _Band(0).Cols   =   5
